...
(define-package "IRON MAIN" "20201206.1"
  "The Iron Main package is a collection of modes and code to allow Emacs to edit and interface (minimally) with a IBM MVS or z/OS instance; mostly assuming that they are on the free Hercules emulator."
  )
